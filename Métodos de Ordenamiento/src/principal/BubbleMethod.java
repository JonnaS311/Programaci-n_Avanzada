...
public class BubbleMethod extends JFrame {
    ...
    /**
     * BubbleMethod is the constructor of the class
     * @param principal
     */
    public BubbleMethod(JMenuBarWindow principal) {
