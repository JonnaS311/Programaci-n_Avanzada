...
public class InsertionMethod extends JFrame {
    ...
    /**
     * InsertionMethod is the constructor of the class
     * @param principal
     */
    public InsertionMethod(JMenuBarWindow principal) {
